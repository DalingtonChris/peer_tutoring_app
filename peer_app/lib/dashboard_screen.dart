...
Widget buildEmptyBox(String msg) {
  return Container(
...
class _LearnerHomeTabState extends State<LearnerHomeTab> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      final results = await Future.wait([
        http.get(Uri.parse('$kBaseUrl/api/student/requests/$studentId'))
            .timeout(const Duration(seconds: 10)),
        http.get(Uri.parse('$kBaseUrl/api/student/conversations/$studentId'))
            .timeout(const Duration(seconds: 10)),
      ]);
  ...
  Widget build(BuildContext context) {
    ...
    final int studentId = parseId(widget.currentUserData['id']);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (_requests.isEmpty)
                      buildEmptyBox("You haven't sent any requests yet.")
                    else
                      ..._requests.map((req) {
                    ...
                    if (_conversations.isEmpty)
                      ...
                      ..._conversations.map((conv) {
                        ...
                        final tutorId = parseId(conv['tutor_id']);
                        final color = getAvatarColor(tutorName);
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            trailing: Text(
                              formatTime(conv['last_time']?.toString()),
                              style: const TextStyle(
...
class _TutorHomeTabState extends State<TutorHomeTab> {
  ...
  Future<void> _loadStats() async {
    ...
    try {
      ...
      final response = await http
          .get(Uri.parse('$kBaseUrl/api/tutor/stats/$tutorId'))
  ...
  Future<void> _sendReply(int requestId) async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('$kBaseUrl/api/tutor/reply/$requestId'),
  ...
  Widget _buildRequestCard(Map<String, dynamic> req) {
    final int requestId = parseId(req['id']);
    ...
    final Color avatarColor = getAvatarColor(studentName);
...
class _TutorMessagesTabState extends State<TutorMessagesTab> {
  ...
  Future<void> _loadConversations() async {
    ...
    try {
      final response = await http
          .get(Uri.parse('$kBaseUrl/api/conversations/${widget.tutorId}'))
                  ...
                  : RefreshIndicator(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final color = getAvatarColor(studentName);
                          ...
                          return ListTile(
                            ...
                            onTap: () {
                              final int tutorIdInt = parseId(widget.tutorId);
                              final int studentIdInt = parseId(studentId);
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => ChatScreen(
